...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'kaliop_exo.antispam' => 'getKaliopExo_AntispamService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'exoKaliop', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Kaliop/ExoBundle/Entity'))), 'Kaliop\\ExoBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('KaliopExoBundle' => 'Kaliop\\ExoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_262333ecb18b4c26384fa27081f6cb46f1057a8d5c2e4c6647d150b92202b60b');
    ...
    /**
     * Gets the 'kaliop_exo.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Kaliop\ExoBundle\AntiSpam\AntiSpam A Kaliop\ExoBundle\AntiSpam\AntiSpam instance
     */
    protected function getKaliopExo_AntispamService()
    {
        return $this->services['kaliop_exo.antispam'] = new \Kaliop\ExoBundle\AntiSpam\AntiSpam($this->get('swiftmailer.mailer.default'), 'en', 50);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Kaliop/ExoBundle/Resources/views'), 'KaliopExo');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fea8ba37bf53c86bced7a4cc94ec1d71a82ffb73');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58bfc733a28e23.67865616')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'KaliopExoBundle' => 'Kaliop\\ExoBundle\\KaliopExoBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'KaliopExoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Kaliop/ExoBundle'),
                    'namespace' => 'Kaliop\\ExoBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'secret' => 'fea8ba37bf53c86bced7a4cc94ec1d71a82ffb73',
            'locale' => 'en',
            ...
            'kernel.secret' => 'fea8ba37bf53c86bced7a4cc94ec1d71a82ffb73',
