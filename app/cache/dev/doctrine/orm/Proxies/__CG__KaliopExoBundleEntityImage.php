...
namespace Proxies\__CG__\Kaliop\ExoBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \Kaliop\ExoBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Kaliop\\ExoBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Kaliop\\ExoBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'Kaliop\\ExoBundle\\Entity\\Image' . "\0" . 'alt');
        }
